...
main (int argc, char *argv[])
{
  ...
  ***/
  ...
  tlmClient80211pHelper.SetAttribute ("Client", (PointerValue) sumoClient); // pass TraciClient object for accessing sumo in application
  ...
  SHUTDOWN_FCN shutdownWifiNode = [] (Ptr<Node> exNode,std::string vehicleID)
    {
      ...
      Ptr<tlmClient80211p> tlmClient80211p_ = exNode->GetApplication(0)->GetObject<tlmClient80211p>();
      if(tlmClient80211p_)
