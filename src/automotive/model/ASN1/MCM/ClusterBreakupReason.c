...
int
ClusterBreakupReason_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
ClusterBreakupReason_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
ClusterBreakupReason_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ClusterBreakupReason_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
ClusterBreakupReason_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
ClusterBreakupReason_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ClusterBreakupReason_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
ClusterBreakupReason_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ClusterBreakupReason_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static const asn_INTEGER_specifics_t asn_SPC_ClusterBreakupReason_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ClusterBreakupReason = {
	...
	"ClusterBreakupReason",
	ClusterBreakupReason_free,
	ClusterBreakupReason_print,
	ClusterBreakupReason_constraint,
	ClusterBreakupReason_decode_ber,
	ClusterBreakupReason_encode_der,
	ClusterBreakupReason_decode_xer,
	ClusterBreakupReason_encode_xer,
