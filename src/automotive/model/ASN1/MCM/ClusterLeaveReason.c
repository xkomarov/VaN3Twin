...
int
ClusterLeaveReason_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
ClusterLeaveReason_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
ClusterLeaveReason_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ClusterLeaveReason_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
ClusterLeaveReason_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
ClusterLeaveReason_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ClusterLeaveReason_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
ClusterLeaveReason_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ClusterLeaveReason_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static const asn_INTEGER_specifics_t asn_SPC_ClusterLeaveReason_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ClusterLeaveReason = {
	"ClusterLeaveReason",
	"ClusterLeaveReason",
	ClusterLeaveReason_free,
	ClusterLeaveReason_print,
	ClusterLeaveReason_constraint,
	ClusterLeaveReason_decode_ber,
	ClusterLeaveReason_encode_der,
	ClusterLeaveReason_decode_xer,
	ClusterLeaveReason_encode_xer,
