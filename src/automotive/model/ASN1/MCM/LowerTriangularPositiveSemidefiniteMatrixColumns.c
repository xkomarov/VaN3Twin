...
static asn_TYPE_member_t asn_MBR_LowerTriangularPositiveSemidefiniteMatrixColumns_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_LowerTriangularPositiveSemidefiniteMatrixColumns_specs_1 = {
