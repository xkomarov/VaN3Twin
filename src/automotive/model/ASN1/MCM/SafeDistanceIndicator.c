...
int
SafeDistanceIndicator_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SafeDistanceIndicator_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SafeDistanceIndicator_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SafeDistanceIndicator_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SafeDistanceIndicator_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SafeDistanceIndicator_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SafeDistanceIndicator_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SafeDistanceIndicator_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SafeDistanceIndicator_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_SafeDistanceIndicator = {
	...
	"SafeDistanceIndicator",
	SafeDistanceIndicator_free,
	SafeDistanceIndicator_print,
	SafeDistanceIndicator_constraint,
	SafeDistanceIndicator_decode_ber,
	SafeDistanceIndicator_encode_der,
	SafeDistanceIndicator_decode_xer,
	SafeDistanceIndicator_encode_xer,
