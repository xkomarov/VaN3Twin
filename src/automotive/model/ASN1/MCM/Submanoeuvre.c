...
static asn_TYPE_member_t asn_MBR_Submanoeuvre_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_Submanoeuvre_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_Submanoeuvre = {
	...
	sizeof(asn_DEF_Submanoeuvre_tags_1)
		/sizeof(asn_DEF_Submanoeuvre_tags_1[0]), /* 1 */
	asn_DEF_Submanoeuvre_tags_1,	/* Same as above */
	sizeof(asn_DEF_Submanoeuvre_tags_1)
		/sizeof(asn_DEF_Submanoeuvre_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_Submanoeuvre_1,
	3,	/* Elements count */
	&asn_SPC_Submanoeuvre_specs_1	/* Additional specs */
};
