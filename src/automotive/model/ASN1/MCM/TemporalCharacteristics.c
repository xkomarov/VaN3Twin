...
static int
memb_tRROccupancyStartTime_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_tRROccupancyEndTime_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_TYPE_member_t asn_MBR_TemporalCharacteristics_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_TemporalCharacteristics_specs_1 = {
