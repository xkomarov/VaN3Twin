...
int
TrafficDirection_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
TrafficDirection_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
TrafficDirection_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	TrafficDirection_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
TrafficDirection_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
TrafficDirection_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TrafficDirection_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
TrafficDirection_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TrafficDirection_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_TrafficDirection = {
	"TrafficDirection",
	"TrafficDirection",
	TrafficDirection_free,
	TrafficDirection_print,
	TrafficDirection_constraint,
	TrafficDirection_decode_ber,
	TrafficDirection_encode_der,
	TrafficDirection_decode_xer,
	TrafficDirection_encode_xer,
