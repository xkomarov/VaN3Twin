...
static asn_TYPE_member_t asn_MBR_VehicleManoeuvreContainer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleManoeuvreContainer, vehicleCurrentStateContainer),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_VehicleCurrentStateContainer,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"vehicleCurrentStateContainer"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleManoeuvreContainer, submaneuvres),
	...
	{ ATF_POINTER, 1, offsetof(struct VehicleManoeuvreContainer, manoeuvreAdvice),
...
static const asn_TYPE_tag2member_t asn_MAP_VehicleManoeuvreContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* vehicleCurrentStateContainer */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* submaneuvres */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* manoeuvreAdvice */
};
static asn_SEQUENCE_specifics_t asn_SPC_VehicleManoeuvreContainer_specs_1 = {
