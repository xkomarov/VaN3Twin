...
int
VruEnvironment_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
VruEnvironment_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
VruEnvironment_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	VruEnvironment_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
VruEnvironment_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
VruEnvironment_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VruEnvironment_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
VruEnvironment_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VruEnvironment_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_VruEnvironment = {
	...
	"VruEnvironment",
	VruEnvironment_free,
	VruEnvironment_print,
	VruEnvironment_constraint,
	VruEnvironment_decode_ber,
	VruEnvironment_encode_der,
	VruEnvironment_decode_xer,
	VruEnvironment_encode_xer,
