 ...
 * ============================================================================ */
#ifndef greenWindowCLIENT_H
#define greenWindowCLIENT_H
...
class greenWindowClient : public Application
{
public:
...
private:
  ...
  void updategreenWindowControl (void);

  
  void applygreenWindowAction (double speed, int r, int g, int b);
  ...
  EventId m_spatemOut;
  EventId m_greenWindowUpdateEvent; 
  ...
  bool m_greenWindowActive = false; 
