...
namespace ns3
{
  ...
  public:
    ...
    void setupContainer(bool CABasicService_enabled,bool DENBasicService_enabled,bool VRUBasicService_enabled, bool CPService_enabled,bool security_enabled);
